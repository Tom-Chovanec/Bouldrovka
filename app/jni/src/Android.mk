...
LOCAL_SRC_FILES := \
	app.cpp icon.cpp main.cpp renderer.cpp resource_manager.cpp scene.cpp object.cpp image.cpp simple_button.cpp text.cpp colors.cpp boulder_selection.cpp
